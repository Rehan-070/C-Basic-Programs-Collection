/* 
	Aim: Program In C++ For Hybrid Inheritance.
*/
#include<iostream>
using namespace std;
...
/* Output
 ...
 Your Sports Marks :	40
 Your Total Marks =	520/650
 Your Total Percent =	80
*/
